 ...
 */
public class StructuredCoalescentUntypedTreeDensity2 extends TreeDistribution {
    ...
    public StructuredCoalescentUntypedTreeDensity2() {
    ...
    public double calculateLogP() {
        ...
        for (int p=0; p<nParticles; p++) {
            ...
            Node startingLeaf = tree.getNode(Randomizer.nextInt(tree.getLeafNodeCount()));
            logParticleWeights[p] -= colourTree(startingLeaf);
    ...
    protected double colourTree(Node startingNode) {
